...
namespace TestUngDung.Areas.Administrator.Controllers
{
    ...
    {
        MaiXuanDuyContext dbPdc = new MaiXuanDuyContext();
        ...
        [HandleError]
        [HttpPost]
        public ActionResult Create(ThuongHieu createPdc, HttpPostedFileBase file)
        {
            if (Session["accname"] == null)
            {
                Session["accname"] = null;
        ...
        [HandleError]
        [HttpPost]
        public ActionResult Edit(ThuongHieu editPdc, HttpPostedFileBase file)
        {
            if (Session["accname"] == null)
            {
                Session["accname"] = null;
